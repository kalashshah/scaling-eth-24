...
contract PlonkVerifier {
    ...
    uint256 constant Qmx =
        7911762822259152604163250299106214602581482635213234252227608582676193361549;
    uint256 constant Qmy =
        4129698158719286665896775560646401808879011931194233786711839762554825547167;
    uint256 constant Qlx =
        14871623200139138327361377415716137547413406171920273377111492652115253963266;
    uint256 constant Qly =
        19214329469599016711253060975733325986359595125689407280777987258646426585335;
    uint256 constant Qrx =
        18084761064818843622554564264314932091794805138744942178847345592122791182930;
    uint256 constant Qry =
        16155066181293728172292645518293953378577793294854874683981666733570372191731;
    uint256 constant Qox =
        6654540660156855377947111374978265789403002822361215141088247648387915835987;
    uint256 constant Qoy =
        13035591463664535845692611130650178040731623295129256308662893464142769123590;
    uint256 constant Qcx =
        19593050921196208028230406432362896499969465723852288741821279417604774757517;
    uint256 constant Qcy =
        16603123092750778540347362206840066879359962318901095649127259300495310561071;
    uint256 constant S1x =
        10712841876995415204165395083994750587475548761552730170663710548383761935383;
    uint256 constant S1y =
        6749498043589727210703498853105276740945683972378184669285028929785727395821;
    uint256 constant S2x =
        5310603118717956844902639157162094790016885581628931702518410238716998114667;
    uint256 constant S2y =
        1801356511201048346516566229802157014940335339307994675474401329960586591565;
    uint256 constant S3x =
        12369028529289013957103305587041033432964742592809083241773562682909634753773;
    uint256 constant S3y =
        9991166811369162927684076212921681369503691769105891802642633120941508347653;
